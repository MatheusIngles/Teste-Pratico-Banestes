...
// Componente React para o rodapé (Footer)
export default function Footer() {
    // Hook de estado para armazenar a largura atual da janela
    const [maxw, setmaxw] = useState<number>(window.innerWidth);

    // Tipo auxiliar para representar um link com nome e URL
    type ObjectLink = {
        link: string;
        Nome: string;
    };

    // Listas de links para diferentes seções do rodapé
    const Tecnologias: Array<ObjectLink> = [
        { link: "https://getbootstrap.com/", Nome: "Bootstrap" },
        { link: "https://react.dev/", Nome: "React" },
        { link: "https://www.typescriptlang.org/", Nome: "TypeScript" }
    ];

    const SobreOBanestes: Array<ObjectLink> = [
        { link: "https://www.banestes.com.br/institucional/index_companhia.html", Nome: "A Companhia" },
    ...
    const Atendimento: Array<ObjectLink> = [
        { link: "https://www.banestes.com.br/#:~:text=Atendimento-,Rede%20de%20Ag%C3%AAncias,-SAC%20e%20Telefones", Nome: "Rede de Agências" },
    ...
    // Componente auxiliar para renderizar listas de links
    const ListaDeCoisas = ({ lista }: { lista: Array<ObjectLink> }) => {
        try {
            ...
            console.error(error); // Em caso de erro, mostra no console
            return null;
        }
    };
    ...
    return (
        <footer className='w-100'>
            <div id='divlist'>
                {/* Renderiza diferente para dispositivos móveis e telas maiores */}
                {maxw <= 550 &&
                    <ListGroup>
                        <ListGroup.Item>
            ...
            <div id='Fim' className='w-100'>
                <div className="container">
                    <div className="py-5">
                        ...
                        {/* Rodapé final com redes sociais */}
